...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            val pref = getSharedPreferences(SharedPrefNames.CURRENT_USER_DETAILS, MODE_PRIVATE)
            pref.edit()
                .putString(SharedPrefNames.CURRENT_USER_ID, "temp_user_id")
                .putString(SharedPrefNames.CURRENT_USER_NAME, "temp_user_name")
                .apply()
